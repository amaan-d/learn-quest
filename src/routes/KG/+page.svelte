...
<ol>
  ...
  <li><a href="./KG/Identifying_Counting_upto5/" class="arrow"><i class="fas fa-arrow-right"></i>Identifying and Counting Numbers (up to 5)</a></li>
  <li><a href="./KG/MLGF_upto5/" class="arrow"><i class="fas fa-arrow-right"></i>More, Less, Greater, Fewer (up to 5)</a></li>
  <li><a href="x.com" class="arrow"><i class="fas fa-arrow-right"></i>Identifying and Counting Numbers (up to 10)</a></li>
  ...
  <li><a href="x.com" class="arrow"><i class="fas fa-arrow-right"></i>Identifying and Counting Numbers (up to 20)</a></li>
